...
var __PRIVATE_IndexedDbIndexManager = class {
  constructor(e, t) {
    this.databaseId = t, this.un = new __PRIVATE_MemoryCollectionParentIndex(), this.cn = new ObjectMap((e2) => __PRIVATE_canonifyTarget(e2), (e2, t2) => __PRIVATE_targetEquals(e2, t2)), this.uid = e.uid || "";
  }
  addToCollectionParentIndex(e, t) {
    if (!this.un.has(t)) {
...
var __PRIVATE_ReferenceSet = class {
  constructor() {
    this.Ir = new SortedSet(__PRIVATE_DocReference.Tr), this.Er = new SortedSet(__PRIVATE_DocReference.dr);
  }
  isEmpty() {
...
var __PRIVATE_MemoryMutationQueue = class {
  constructor(e, t) {
    this.indexManager = e, this.referenceDelegate = t, this.mutationQueue = [], this.wr = 1, this.Sr = new SortedSet(__PRIVATE_DocReference.Tr);
  }
  checkEmpty(e) {
...
var __PRIVATE_MemoryTargetCache = class {
  constructor(e) {
    this.persistence = e, this.Or = new ObjectMap((e2) => __PRIVATE_canonifyTarget(e2), __PRIVATE_targetEquals), this.lastRemoteSnapshotVersion = SnapshotVersion.min(), this.highestTargetId = 0, this.Nr = 0, this.Lr = new __PRIVATE_ReferenceSet(), this.targetCount = 0, this.Br = __PRIVATE_TargetIdGenerator.Ln();
  }
  forEachTarget(e, t) {
...
var __PRIVATE_MemoryEagerDelegate = class {
  constructor(e) {
    this.persistence = e, this.Hr = new __PRIVATE_ReferenceSet(), this.Jr = null;
  }
  static Yr(e) {
...
var __PRIVATE_IndexedDbPersistence = class {
  constructor(e, t, n, r, i, s, o, _, a, u, c = 17) {
    if (this.allowTabSynchronization = e, this.persistenceKey = t, this.clientId = n, this.ai = i, this.window = s, this.document = o, this.ui = a, this.ci = u, this.li = c, this.qr = null, this.Qr = false, this.isPrimary = false, this.networkEnabled = true, this.hi = null, this.inForeground = false, this.Pi = null, this.Ii = null, this.Ti = Number.NEGATIVE_INFINITY, this.Ei = (e2) => Promise.resolve(), !__PRIVATE_IndexedDbPersistence.D())
  ...
  setNetworkEnabled(e) {
    this.networkEnabled !== e && (this.networkEnabled = e, this.ai.enqueueAndForget(async () => {
  ...
  async shutdown() {
    this.Qr = false, this.Ni(), this.Ii && (this.Ii.cancel(), this.Ii = null), this.Li(), this.Bi(), await this.Ai.runTransaction("shutdown", "readwrite", ["owner", "clientMetadata"], (e) => {
      const t = new __PRIVATE_IndexedDbTransaction(e, __PRIVATE_ListenSequence.oe);
      return this.Si(t).next(() => this.Ci(t));
    }), this.Ai.close(), this.ki();
  }
  Mi(e, t) {
  ...
  Li() {
    ...
    "function" == typeof (null === (e = this.window) || void 0 === e ? void 0 : e.addEventListener) && (this.hi = () => {
      ...
      isSafari() && (navigator.appVersion.match(e2) || navigator.userAgent.match(e2)) && this.ai.enterRestrictedMode(true), this.ai.enqueueAndForget(() => this.shutdown());
...
var __PRIVATE_QueryEngine = class {
  constructor() {
    this.Wi = false, this.Gi = false, this.zi = 100, this.ji = function __PRIVATE_getDefaultRelativeIndexReadCostPerDocument() {
  ...
  Ji(e, t) {
    ...
    return this.indexManager.getIndexType(e, n).next((r) => 0 === r ? null : (null !== t.limit && 1 === r && (t = __PRIVATE_queryWithLimit(t, null, "F"), n = __PRIVATE_queryToTarget(t)), this.indexManager.getDocumentsMatchingTarget(e, n).next((r2) => {
      ...
      return this.Hi.getDocuments(e, i).next((r3) => this.indexManager.getMinOffset(e, n).next((n2) => {
        ...
        return this.ts(t, s, i, n2.readTime) ? this.Ji(e, __PRIVATE_queryWithLimit(t, null, "F")) : this.ns(e, s, t, n2);
      }));
    })));
  }
  Yi(e, t, n, r) {
  ...
  ns(e, t, n, r) {
    return this.Hi.getDocumentsMatchingQuery(e, n, r).next((e2) => (t.forEach((t2) => {
...
var __PRIVATE_LocalStoreImpl = class {
  constructor(e, t, n, r) {
    this.persistence = e, this.rs = t, this.serializer = r, this.ss = new SortedMap(__PRIVATE_primitiveComparator), this.os = new ObjectMap((e2) => __PRIVATE_canonifyTarget(e2), __PRIVATE_targetEquals), this._s = /* @__PURE__ */ new Map(), this.us = e.getRemoteDocumentCache(), this.$r = e.getTargetCache(), this.Wr = e.getBundleCache(), this.cs(n);
  }
  cs(e) {
...
function __PRIVATE_localStoreAllocateTarget(e, t) {
  ...
  return n.persistence.runTransaction("Allocate target", "readwrite", (e2) => {
    let r;
    return n.$r.getTargetData(e2, t).next((i) => i ? (r = i, PersistencePromise.resolve(r)) : n.$r.allocateTargetId(e2).next((i2) => (r = new TargetData(t, i2, "TargetPurposeListen", e2.currentSequenceNumber), n.$r.addTargetData(e2, r).next(() => r))));
  }).then((e2) => {
...
var __PRIVATE_WebStorageSharedClientState = class {
  constructor(e, t, n, r, i) {
    this.window = e, this.ai = t, this.persistenceKey = n, this.gs = r, this.syncEngine = null, this.onlineStateHandler = null, this.sequenceNumberHandler = null, this.ps = this.ys.bind(this), this.ws = new SortedMap(__PRIVATE_primitiveComparator), this.started = false, this.Ss = [];
    const s = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
    this.storage = this.window.localStorage, this.currentUser = i, this.bs = createWebStorageClientStateKey(this.persistenceKey, this.gs), this.Ds = function createWebStorageSequenceNumberKey(e2) {
      return `firestore_sequence_number_${e2}`;
    }(this.persistenceKey), this.ws = this.ws.insert(this.gs, new __PRIVATE_LocalClientState()), this.Cs = new RegExp(`^firestore_clients_${s}_([^_]*)$`), this.vs = new RegExp(`^firestore_mutations_${s}_(\\d+)(?:_(.*))?$`), this.Fs = new RegExp(`^firestore_targets_${s}_(\\d+)$`), this.Ms = function createWebStorageOnlineStateKey(e2) {
    ...
    }(this.persistenceKey), this.window.addEventListener("storage", this.ps);
  }
  static D(e) {
  ...
  async start() {
    ...
    for (const e2 of this.Ss)
      this.ys(e2);
    this.Ss = [], this.window.addEventListener("pagehide", () => this.shutdown()), this.started = true;
  }
...
var __PRIVATE_WebChannelConnection = class extends class __PRIVATE_RestConnection {
  ...
  Lo(e, t, n) {
    ...
    void 0 !== a && (_.longPollingTimeout = Math.round(1e3 * a)), this.useFetchStreams && (_.xmlHttpFactory = new FetchXmlHttpFactory({})), this.xo(_.initMessageHeaders, t, n), _.encodeInitMessageHeaders = true;
    const u = i.join("");
    ...
    return __PRIVATE_unguardedEventListen(c, WebChannel.EventType.OPEN, () => {
      ...
      if (!h) {
        ...
        if (o2) {
          ...
          void 0 === n3 && (n3 = C.INTERNAL, i3 = "Unknown error status: " + t3 + " with message " + o2.message), h = true, P.wo(new FirestoreError(n3, i3)), c.close();
        } else
...
var __PRIVATE_ExponentialBackoff = class {
  constructor(e, t, n = 1e3, r = 1.5, i = 6e4) {
    this.ai = e, this.timerId = t, this.Bo = n, this.ko = r, this.qo = i, this.Qo = 0, this.Ko = null, this.$o = Date.now(), this.reset();
  }
  reset() {
    this.Qo = 0;
  }
  ...
  Wo(e) {
    ...
    r > 0 && __PRIVATE_logDebug("ExponentialBackoff", `Backing off for ${r} ms (base delay: ${this.Qo} ms, delay with jitter: ${t} ms, last attempt: ${n} ms ago)`), this.Ko = this.ai.enqueueAfterDelay(this.timerId, r, () => (this.$o = Date.now(), e())), this.Qo *= this.ko, this.Qo < this.Bo && (this.Qo = this.Bo), this.Qo > this.qo && (this.Qo = this.qo);
  }
  zo() {
...
var __PRIVATE_PersistentStream = class {
  constructor(e, t, n, r, i, s, o, _) {
    this.ai = e, this.jo = n, this.Ho = r, this.connection = i, this.authCredentialsProvider = s, this.appCheckCredentialsProvider = o, this.listener = _, this.state = 0, this.Jo = 0, this.Yo = null, this.Zo = null, this.stream = null, this.Xo = 0, this.e_ = new __PRIVATE_ExponentialBackoff(e, t);
  }
  t_() {
...
var __PRIVATE_PersistentWriteStream = class extends __PRIVATE_PersistentStream {
  ...
  T_(e) {
    return __PRIVATE_hardAssert(!!e.streamToken), this.lastStreamToken = e.streamToken, __PRIVATE_hardAssert(!e.writeResults || 0 === e.writeResults.length), this.listener.m_();
  }
  onNext(e) {
    __PRIVATE_hardAssert(!!e.streamToken), this.lastStreamToken = e.streamToken, this.e_.reset();
...
var __PRIVATE_OnlineStateTracker = class {
  constructor(e, t) {
    this.asyncQueue = e, this.onlineStateHandler = t, this.state = "Unknown", this.w_ = 0, this.S_ = null, this.b_ = true;
  }
  D_() {
    0 === this.w_ && (this.C_("Unknown"), this.S_ = this.asyncQueue.enqueueAfterDelay("online_state_timeout", 1e4, () => (this.S_ = null, this.v_("Backend didn't respond within 10 seconds."), this.C_("Offline"), Promise.resolve())));
  }
  F_(e) {
    "Online" === this.state ? this.C_("Unknown") : (this.w_++, this.w_ >= 1 && (this.M_(), this.v_(`Connection failed 1 times. Most recent error: ${e.toString()}`), this.C_("Offline")));
  }
  set(e) {
    this.M_(), this.w_ = 0, "Online" === e && (this.b_ = false), this.C_(e);
  }
  C_(e) {
...
var __PRIVATE_RemoteStoreImpl = class {
  constructor(e, t, n, r, i) {
    this.localStore = e, this.datastore = t, this.asyncQueue = n, this.remoteSyncer = {}, this.x_ = [], this.O_ = /* @__PURE__ */ new Map(), this.N_ = /* @__PURE__ */ new Set(), this.L_ = [], this.B_ = i, this.B_.oo((e2) => {
      n.enqueueAndForget(async () => {
        __PRIVATE_canUseNetwork(this) && (__PRIVATE_logDebug("RemoteStore", "Restarting streams for network reachability change."), await async function __PRIVATE_restartNetwork(e3) {
          ...
          t2.N_.add(4), await __PRIVATE_disableNetworkInternal(t2), t2.k_.set("Unknown"), t2.N_.delete(4), await __PRIVATE_enableNetworkInternal(t2);
        }(this));
      });
...
function __PRIVATE_remoteStoreListen(e, t) {
  const n = __PRIVATE_debugCast(e);
  n.O_.has(t.targetId) || (n.O_.set(t.targetId, t), __PRIVATE_shouldStartWatchStream(n) ? __PRIVATE_startWatchStream(n) : __PRIVATE_ensureWatchStream(n).n_() && __PRIVATE_sendWatchRequest(n, t));
}
function __PRIVATE_remoteStoreUnlisten(e, t) {
  const n = __PRIVATE_debugCast(e), r = __PRIVATE_ensureWatchStream(n);
  n.O_.delete(t), r.n_() && __PRIVATE_sendUnwatchRequest(n, t), 0 === n.O_.size && (r.n_() ? r.s_() : __PRIVATE_canUseNetwork(n) && n.k_.set("Unknown"));
}
...
async function __PRIVATE_onWatchStreamClose(e, t) {
  __PRIVATE_cleanUpWatchStreamState(e), __PRIVATE_shouldStartWatchStream(e) ? (e.k_.F_(t), __PRIVATE_startWatchStream(e)) : e.k_.set("Unknown");
}
async function __PRIVATE_onWatchStreamChange(e, t, n) {
  if (e.k_.set("Online"), t instanceof __PRIVATE_WatchTargetChange && 2 === t.state && t.cause)
    try {
    ...
    try {
      ...
      n.compareTo(t2) >= 0 && await function __PRIVATE_raiseWatchSnapshot(e2, t3) {
        ...
        return n2.targetChanges.forEach((n3, r) => {
          ...
          if (!r)
            return;
          e2.O_.set(t4, r.withResumeToken(ByteString.EMPTY_BYTE_STRING, r.snapshotVersion)), __PRIVATE_sendUnwatchRequest(e2, t4);
...
async function __PRIVATE_disableNetworkUntilRecovery(e, t, n) {
  if (!__PRIVATE_isIndexedDbTransactionError(t))
    throw t;
  e.N_.add(1), await __PRIVATE_disableNetworkInternal(e), e.k_.set("Offline"), n || (n = () => __PRIVATE_localStoreGetLastRemoteSnapshotVersion(e.localStore)), e.asyncQueue.enqueueRetryable(async () => {
    __PRIVATE_logDebug("RemoteStore", "Retrying IndexedDB access"), await n(), e.N_.delete(1), await __PRIVATE_enableNetworkInternal(e);
  });
}
...
async function __PRIVATE_onWriteStreamClose(e, t) {
  t && __PRIVATE_ensureWriteStream(e).R_ && await async function __PRIVATE_handleWriteError(e2, t2) {
    if (function __PRIVATE_isPermanentWriteError(e3) {
      return __PRIVATE_isPermanentError(e3) && e3 !== C.ABORTED;
    }(t2.code)) {
      const n = e2.x_.shift();
      __PRIVATE_ensureWriteStream(e2).i_(), await __PRIVATE_executeWithRecovery(e2, () => e2.remoteSyncer.rejectFailedWrite(n.batchId, t2)), await __PRIVATE_fillWritePipeline(e2);
    }
...
async function __PRIVATE_remoteStoreHandleCredentialChange(e, t) {
  ...
  n.N_.add(3), await __PRIVATE_disableNetworkInternal(n), r && n.k_.set("Unknown"), await n.remoteSyncer.handleCredentialChange(t), n.N_.delete(3), await __PRIVATE_enableNetworkInternal(n);
}
async function __PRIVATE_remoteStoreApplyPrimaryState(e, t) {
  const n = __PRIVATE_debugCast(e);
  t ? (n.N_.delete(2), await __PRIVATE_enableNetworkInternal(n)) : t || (n.N_.add(2), await __PRIVATE_disableNetworkInternal(n), n.k_.set("Unknown"));
}
function __PRIVATE_ensureWatchStream(e) {
  return e.Q_ || (e.Q_ = function __PRIVATE_newPersistentWatchStream(e2, t, n) {
    ...
    t ? (e.Q_.i_(), __PRIVATE_shouldStartWatchStream(e) ? __PRIVATE_startWatchStream(e) : e.k_.set("Unknown")) : (await e.Q_.stop(), __PRIVATE_cleanUpWatchStreamState(e));
  })), e.Q_;
}
function __PRIVATE_ensureWriteStream(e) {
  return e.K_ || (e.K_ = function __PRIVATE_newPersistentWriteStream(e2, t, n) {
    ...
    t ? (e.K_.i_(), await __PRIVATE_fillWritePipeline(e)) : (await e.K_.stop(), e.x_.length > 0 && (__PRIVATE_logDebug("RemoteStore", `Stopping write stream with ${e.x_.length} pending writes`), e.x_ = []));
  })), e.K_;
}
...
var __PRIVATE_DocumentChangeSet = class {
  ...
  track(e) {
    ...
    n ? 0 !== e.type && 3 === n.type ? this.U_ = this.U_.insert(t, e) : 3 === e.type && 1 !== n.type ? this.U_ = this.U_.insert(t, {
      type: n.type,
      doc: e.doc
...
async function __PRIVATE_eventManagerListen(e, t) {
  ...
  s ? !s.j_() && t.H_() && (r = 2) : (s = new __PRIVATE_QueryListenersInfo(), r = t.H_() ? 0 : 1);
  try {
    switch (r) {
      case 0:
  ...
  if (n.queries.set(i, s), s.z_.push(t), t.Y_(n.onlineState), s.G_) {
...
async function __PRIVATE_eventManagerUnlisten(e, t) {
  ...
  if (s) {
    ...
    e2 >= 0 && (s.z_.splice(e2, 1), 0 === s.z_.length ? i = t.H_() ? 0 : 1 : !s.j_() && t.H_() && (i = 2));
  }
  switch (i) {
    case 0:
...
var pe;
var ye;
(ye = pe || (pe = {})).X_ = "default", ye.Cache = "cache";
var __PRIVATE_QueryListener = class {
  constructor(e, t, n) {
    this.query = e, this.ea = t, this.ta = false, this.na = null, this.onlineState = "Unknown", this.options = n || {};
  }
  Z_(e) {
...
var __PRIVATE_BundleLoader = class {
  constructor(e, t, n) {
    this.ua = e, this.localStore = t, this.serializer = n, this.queries = [], this.documents = [], this.collectionGroups = /* @__PURE__ */ new Set(), this.progress = __PRIVATE_bundleInitialProgress(e);
  }
  ca(e) {
...
var __PRIVATE_View = class {
  constructor(e, t) {
    this.query = e, this.Ia = t, this.Ta = null, this.hasCachedResults = false, this.current = false, this.Ea = __PRIVATE_documentKeySet(), this.mutatedKeys = __PRIVATE_documentKeySet(), this.da = __PRIVATE_newQueryComparator(e), this.Aa = new DocumentSet(this.da);
  }
  get Ra() {
    return this.Ia;
  }
    ...
    if (e.inorderTraversal((e2, t2) => {
      ...
      if (u && c) {
        u.data.isEqual(c.data) ? l !== h && (n.track({
          ...
          type: 2,
          doc: c
        }), P = true, (_ && this.da(c, _) > 0 || a && this.da(c, a) < 0) && (o = true));
      } else
        !u && c ? (n.track({
          type: 0,
          doc: c
...
var LimboResolution = class {
  constructor(e) {
    this.key = e, this.Da = false;
  }
};
var __PRIVATE_SyncEngineImpl = class {
  constructor(e, t, n, r, i, s) {
    this.localStore = e, this.remoteStore = t, this.eventManager = n, this.sharedClientState = r, this.currentUser = i, this.maxConcurrentLimboResolutions = s, this.Ca = {}, this.va = new ObjectMap((e2) => __PRIVATE_canonifyQuery(e2), __PRIVATE_queryEquals), this.Fa = /* @__PURE__ */ new Map(), this.Ma = /* @__PURE__ */ new Set(), this.xa = new SortedMap(DocumentKey.comparator), this.Oa = /* @__PURE__ */ new Map(), this.Na = new __PRIVATE_ReferenceSet(), this.La = {}, this.Ba = /* @__PURE__ */ new Map(), this.ka = __PRIVATE_TargetIdGenerator.Bn(), this.onlineState = "Unknown", this.qa = void 0;
  }
  get isPrimaryClient() {
    return true === this.qa;
  }
...
async function __PRIVATE_syncEngineListen(e, t, n = true) {
  ...
  let i;
  const s = r.va.get(t);
  return s ? (r.sharedClientState.addLocalQueryTarget(s.targetId), i = s.view.ba()) : i = await __PRIVATE_allocateTargetAndMaybeListen(
    r,
    t,
    n,
    true
...
async function __PRIVATE_initializeViewAndComputeSnapshot(e, t, n, r, i) {
  e.Qa = (t2, n2, r2) => async function __PRIVATE_applyDocChanges(e2, t3, n3, r3) {
    ...
    i2.ts && (i2 = await __PRIVATE_localStoreExecuteQuery(
      e2.localStore,
      t3.query,
      false
...
async function __PRIVATE_syncEngineApplyRemoteEvent(e, t) {
  ...
  try {
    ...
    t.targetChanges.forEach((e3, t2) => {
      const r = n.Oa.get(t2);
      r && (__PRIVATE_hardAssert(e3.addedDocuments.size + e3.modifiedDocuments.size + e3.removedDocuments.size <= 1), e3.addedDocuments.size > 0 ? r.Da = true : e3.modifiedDocuments.size > 0 ? __PRIVATE_hardAssert(r.Da) : e3.removedDocuments.size > 0 && (__PRIVATE_hardAssert(r.Da), r.Da = false));
...
async function __PRIVATE_syncEngineRejectListen(e, t, n) {
  ...
  if (s) {
    ...
    await __PRIVATE_syncEngineApplyRemoteEvent(r, i2), r.xa = r.xa.remove(s), r.Oa.delete(t), __PRIVATE_pumpEnqueuedLimboResolutions(r);
  } else
...
function __PRIVATE_removeAndCleanupTarget(e, t, n = null) {
  ...
  if (e.Fa.delete(t), e.isPrimaryClient) {
    e.Na.mr(t).forEach((t2) => {
      e.Na.containsKey(t2) || __PRIVATE_removeLimboTarget(e, t2);
    });
  }
}
...
function __PRIVATE_updateTrackedLimbos(e, t, n) {
  for (const r of n)
    if (r instanceof __PRIVATE_AddedLimboDocument)
      ...
      e.Na.containsKey(r.key) || __PRIVATE_removeLimboTarget(e, r.key);
    } else
      fail();
}
...
async function __PRIVATE_syncEngineApplyActiveTargetsChange(e, t, n) {
  ...
  if (r.qa) {
    ...
    for (const e2 of n)
      r.Fa.has(e2) && await __PRIVATE_localStoreReleaseTarget(
        r.localStore,
        e2,
        false
      ).then(() => {
...
var __PRIVATE_IndexedDbOfflineComponentProvider = class extends MemoryOfflineComponentProvider {
  ...
  async initialize(e) {
    await super.initialize(e), await this.Ua.initialize(this, e), await __PRIVATE_syncEngineEnsureWriteCallbacks(this.Ua.syncEngine), await __PRIVATE_fillWritePipeline(this.Ua.remoteStore), await this.persistence.pi(() => (this.gcScheduler && !this.gcScheduler.started && this.gcScheduler.start(), this.indexBackfillerScheduler && !this.indexBackfillerScheduler.started && this.indexBackfillerScheduler.start(), Promise.resolve()));
  }
  createLocalStore(e) {
    return __PRIVATE_newLocalStore(this.persistence, new __PRIVATE_QueryEngine(), e.initialUser, this.serializer);
  }
...
var __PRIVATE_MultiTabOfflineComponentProvider = class extends __PRIVATE_IndexedDbOfflineComponentProvider {
  constructor(e, t) {
    super(e, t, false), this.Ua = e, this.cacheSizeBytes = t, this.synchronizeTabs = true;
  }
  async initialize(e) {
    ...
    }, await this.sharedClientState.start()), await this.persistence.pi(async (e2) => {
...
var OnlineComponentProvider = class {
  ...
  async terminate() {
    ...
    await async function __PRIVATE_remoteStoreShutdown(e2) {
      ...
      __PRIVATE_logDebug("RemoteStore", "RemoteStore shutting down."), t2.N_.add(5), await __PRIVATE_disableNetworkInternal(t2), t2.B_.shutdown(), t2.k_.set("Unknown");
...
var __PRIVATE_BundleReaderImpl = class {
  constructor(e, t) {
    this.za = e, this.serializer = t, this.metadata = new __PRIVATE_Deferred(), this.buffer = new Uint8Array(), this.ja = function __PRIVATE_newTextDecoder() {
...
var __PRIVATE_TransactionRunner = class {
  constructor(e, t, n, r, i) {
    this.asyncQueue = e, this.datastore = t, this.options = n, this.updateFunction = r, this.deferred = i, this.tu = n.maxAttempts, this.e_ = new __PRIVATE_ExponentialBackoff(this.asyncQueue, "transaction_retry");
  }
  nu() {
    this.tu -= 1, this.ru();
  }
...
function __PRIVATE_firestoreClientEnableNetwork(e) {
  return e.asyncQueue.enqueue(async () => {
    ...
    return t.setNetworkEnabled(true), function __PRIVATE_remoteStoreEnableNetwork(e2) {
      const t2 = __PRIVATE_debugCast(e2);
      return t2.N_.delete(0), __PRIVATE_enableNetworkInternal(t2);
    }(n);
  });
}
function __PRIVATE_firestoreClientDisableNetwork(e) {
  return e.asyncQueue.enqueue(async () => {
    ...
    return t.setNetworkEnabled(false), async function __PRIVATE_remoteStoreDisableNetwork(e2) {
      const t2 = __PRIVATE_debugCast(e2);
      t2.N_.add(0), await __PRIVATE_disableNetworkInternal(t2), t2.k_.set("Offline");
    }(n);
  });
}
...
function __PRIVATE_firestoreClientAddSnapshotsInSyncListener(e, t) {
  ...
  return e.asyncQueue.enqueueAndForget(async () => function __PRIVATE_addSnapshotsInSyncListener(e2, t2) {
    __PRIVATE_debugCast(e2).J_.add(t2), t2.next();
...
var __PRIVATE_AsyncQueueImpl = class {
  constructor() {
    this._u = Promise.resolve(), this.au = [], this.uu = false, this.cu = [], this.lu = null, this.hu = false, this.Pu = false, this.Iu = [], this.e_ = new __PRIVATE_ExponentialBackoff(this, "async_queue_retry"), this.Tu = () => {
  ...
  enqueueAfterDelay(e, t, n) {
    this.Eu(), this.Iu.indexOf(e) > -1 && (t = 0);
...
!function __PRIVATE_registerFirestore(e, t = true) {
  ...
  }, "PUBLIC").setMultipleInstances(true)), registerVersion(S, "4.6.5", e), registerVersion(S, "4.6.5", "esm2017");
}();
export {
